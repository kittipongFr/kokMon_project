...
<body  onload="getEnvironment()" >
    ...
    <!-- Left side column. contains the logo and sidebar -->
      ...
      <h1>
        <i class="glyphicon glyphicon-user hidden-xs"></i> <span class="hidden-xs">ข้อมูลการผลิตในระบบ</span>
        <a  class="btn btn-primary btn-sm text-white"   id="openFormBtn">เพิ่มรายการผลิต <i class="fa fa-plus"></i></a>   
...
?>
<?php
  include 'popupAddMft.php'; 
  include 'popupEditMft.php';
?>
