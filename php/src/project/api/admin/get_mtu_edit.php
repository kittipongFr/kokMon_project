    ...
    if (isset($json_data["id"])) {
        ...
        if ($stmt) {
            ...
            if (!empty($datalist['material_used'])) {
                ...
                $strSQLDetail = "SELECT mtu.material_id, mtu.amount AS mtu_amount,mt.amount AS mt_amount,
                ...
                if ($stmtDetail) {
                    ...
                    while ($resultQueryDetail = mysqli_fetch_array($queryDetail)) {
                        ...
                        $amount = $resultQueryDetail['mtu_amount'];
                        $cost = $resultQueryDetail['cost'];
                        $mt_amount = $resultQueryDetail['mt_amount'];
                    ...
                    $strSQLMaterial = "SELECT material_id, name, unit , amount FROM material";
                    ...
                    while ($resultQueryMaterial = mysqli_fetch_assoc($queryMaterial)) {
                        ...
                        $amount = $resultQueryMaterial['amount'];
