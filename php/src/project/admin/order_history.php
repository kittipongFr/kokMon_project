...
<body  onload="getEnvironment()" >
  <div class="wrapper">
    ...
    <!-- Left side column. contains the logo and sidebar -->
      ...
      <h1 class="mb-4">
        <i class="glyphicon glyphicon-user hidden-xs"></i> <span class="hidden-xs">ข้อมูลประวัติคำสั่งซื้อในระบบ</span>
...
function numberWithCommas(x) {
    ...
    return x;
     ...
     function getOrderList(){
        let uri= "http://127.0.0.1:8080/project/api/admin/back_get_order_history.php";
        let innerhtml = "";
        $.ajax({
            type:"POST",
            url:uri,
