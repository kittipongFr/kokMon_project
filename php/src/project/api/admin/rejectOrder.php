...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mem_id = isset($json_data["mem_id"]) ? trim($json_data["mem_id"]) : "";
...
$strUpdate = "UPDATE orders SET status = '8' WHERE order_id = '$id'";
...
$strSQLAdsInsert = "INSERT INTO `mem_reject` (order_id,mem_id ,detail) VALUES (?, ?,?)";
...
mysqli_stmt_bind_param($stmtAdsInsert, "sss", $id,$mem_id ,$detail);
...
<?php
# output
$json_response = json_encode(array("result" => 1,  "message" => "ปฏิเสธเรียบร้อย"));
echo $json_response;
