...
<button class="btn btn-primary" style="float: right;" type="button" id="addMt">เพิ่มรายการ <span class='fas fa-plus'></span></button>

<button class="btn btn-success mx-2" type="button" id="submitBtn">บันทึกการผลิต <i class='fas fa-file'></i></button>
...
function appendInputSet(counter) {
    ...
    newLabel.textContent = 'รายการผลิตที่ ' + counter + ':';

    var newInput = document.createElement('div');
    newInput.className = 'col-sm-12';

    // Append dropdown
    var dropdownId = appendDropdown('pro_id', 'ชื่อสินค้า(ห้ามเลือกซ้ำ!)', newInput);

    // Append input for amount
    var amountId = appendInput('amount', 'จำนวนผลิต', newInput, counter);
