...
<body>
			...
			<div class="wrap-login100">
				...
				<h3 class="text-center mb-2" >
					...
					<div class="wrap-input100 validate-input" data-validate = "กรุณากรอกอีเมลล์ ">
						<input class="input100" type="text" id="email" name="email" placeholder="อีเมล์">
    ...
    function login() {
        ...
        $.ajax({
            type:"POST",
            url:"http://localhost:8080/project/api/admin/back_get_login.php",
            async:false,
            ...
            success:function(response){
                ...
                if(response.result === 1){
                    ...
                    localStorage.setItem("member_profile",JSON.stringify(response.datalist));
					...
					console.log(response.result); 
                	console.log(response.message);
                    window.location.replace("http://127.0.0.1:8080/project/admin/index.php");  
					//  <--?menu=productlist-->
                }else{
...
<!--===============================================================================================-->
	<script src="../assets/login-asset/js/main.js"></script>
